...
export function GraficoLinhas() {
  ...
  return (
    <div className="h-full ml-20 min-h-[400px] max-h-[100%] w-full min-w-[800px] max-w-[100%] p-6 mt-6 bg-gradient-to-r from-gray-800 via-gray-900 to-black dark:from-gray-900 dark:via-black dark:to-gray-800 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
