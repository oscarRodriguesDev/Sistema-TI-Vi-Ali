    ...
    <div className="container mx-auto">
      ...
      <div className="mx-auto lg:max-w-screen-lg lg:px-20">
        {FAQS.map(({ title, desc }, key) => (
           ...
           icon="" // Se não precisar de ícone, deixe como string vazia ou ajuste conforme necessário
           disabled={open === null}
           className="mb-8"
           placeholder="Placeholder"
           // Passe as outras props necessárias
           onPointerEnterCapture={() => {}}
           onPointerLeaveCapture={() => {}}
         >
           <div className="accordion-header">Accordion {key}</div>
           <div className={`accordion-content ${open === key ? "animate" : ""}`}>
             <p>Conteúdo do Accordion {key}</p>
           </div>
         </Accordion>
        ))}
      </div>
